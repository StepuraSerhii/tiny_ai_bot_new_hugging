...
def generate_meme_text(image_bytes: bytes, theme_hint: str = "", scene: str | None = None) -> tuple[str, str]:
    ...
    # Рандомний кут подачі жарту — щоразу інший, навіть для того самого фото
    humor_angles = [
        "Уяви що це підпис у груповому чаті сім'ї. Що написала б тітка Люда?",
        "Це скріншот з реаліті-шоу. Який субтитр внизу екрана?",
        "Уяви монолог головного героя — втомленого українця 2024 року.",
        "Це ілюстрація до статті в газеті «Факти». Який підпис під фото?",
        "Що сказав би дід, побачивши це вперше в житті?",
        "Це мотиваційний плакат. Але демотиваційний.",
        "Уяви що це постер до фільму. Яка крилата фраза?",
        "Це фото з корпоративного тімбілдінгу. Що написав би HR у підписі?",
        "Це кадр з документалки про виживання. Що каже закадровий голос?",
        "Уяви внутрішній монолог об'єкта на фото прямо зараз.",
        "Це реклама чогось абсолютно не пов'язаного з тим, що на фото.",
        "Перший рядок — ситуація, другий — несподівана причина або наслідок.",
        "Це нотатка в щоденнику людини на фото (або поруч з нею).",
        "Що написав би бот технічної підтримки, описуючи цю ситуацію?",
        "Це заголовок новини на ukr.net. Шокуючий і трохи абсурдний.",
    ]
    chosen_angle = random.choice(humor_angles)
